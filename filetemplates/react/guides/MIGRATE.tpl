...
If you are migrating from a previous version of ext-react to ext-react-{toolkit},

please submit a support ticket at https://support.sencha.com with the subject 'upgrade ext-react-{toolkit}'.
