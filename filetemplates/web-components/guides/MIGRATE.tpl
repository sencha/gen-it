...
If you are migrating from a previous version of ext-web-components to ext-web-components-{toolkit},

please submit a support ticket at https://support.sencha.com with the subject 'upgrade ext-web-components-{toolkit}'.
