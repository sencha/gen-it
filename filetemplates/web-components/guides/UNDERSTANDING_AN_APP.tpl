## Understanding an app for @sencha/ext-web-components-{toolkit}{bundle}
...
follow the [Getting Started guide](https://github.com/sencha/ext-web-components/blob/ext-web-components-7.1.1/packages/ext-web-components-{toolkit}{bundle}/GETTING_STARTED.md).
...
```
npm install @sencha/ext-web-components-{toolkit}
``
...
```
<script
 src="./node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}/{toolkit}.engine.js">
</script>
<link
 rel="stylesheet"
 type="text/css"
 href="node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}/material/material-all.css">
</link>
```
...
in the './node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}' folder, you will notice several theme folders.  To change
...
<link
 rel="stylesheet"
 type="text/css"
 href="node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}/triton/triton-all.css">
</link>
```
...
```
href="node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}/graphite/graphite-all.css">
href="node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}/material/material-all.css">
href="node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}/triton/triton-all.css">
```
</tpl>

<tpl if="toolkit == '{toolkit}'">
here are all the {toolkit} themes available:

```
href="node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}/ios/ios-all.css">
href="node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}/material/material-all.css">
href="node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}/neptune/neptune-all.css">
href="node_modules/@sencha/ext-web-components-{toolkit}/ext-runtime-{toolkit}/triton/triton-all.css">
```
</tpl>
