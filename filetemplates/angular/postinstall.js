...
switch(framework) {
  case 'react':
    ...
    if (!fs.existsSync(`../../../${copyFolder}index.html`)) {
      console.log(`${prefix} ./${copyFolder}index.html does not exist, not creating ext-${toolkit}-runtime folder`);
      return
    }
    break;
  case 'angular':
    ...
    if (!fs.existsSync('../../../angular.json')) {
      console.log(`${prefix} ./angular.json does not exist, not creating ext-${toolkit}-runtime folder`);
      return
    }
    break;
  default:
...
if (packageJsonApp.devDependencies != undefined) {
    ...
    if (devDependencies != undefined) {
        console.log(`${prefix} @sencha/ext-webpack-plugin is defined, not creating ext-${toolkit}-runtime folder`);
        return
    }
}

if (fs.existsSync('../../../webpack.config.js')) {
    console.log(`${prefix} ./webpack.config.js exists, not creating ext-${toolkit}-runtime folder`);
    return
}
