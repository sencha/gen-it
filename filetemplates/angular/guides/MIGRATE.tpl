...
If you are migrating from a previous version of ext-angular to ext-angular-{toolkit},

please submit a support ticket at https://support.sencha.com with the subject 'upgrade ext-angular-{toolkit}'.
