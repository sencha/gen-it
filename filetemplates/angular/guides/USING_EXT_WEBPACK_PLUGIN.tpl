...
[For ext-angular-{toolkit}{bundle}](https://github.com/sencha/ext-angular/blob/ext-angular-7.3.0/packages/ext-angular-{toolkit}{bundle}/GETTING_STARTED.md)
...
"@sencha/ext-angular-{toolkit}{bundle}": "~7.3.0",
"@sencha/ext": "~7.3.0",
"@sencha/ext-{toolkit}": "~7.3.0",
"@sencha/ext-{toolkit}-theme-material": "~7.3.0",
