...
export default class Ext_grid_AdvancedGroupStore extends Ext_util_Observable {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_grid_AdvancedGroupStore.PROPERTIES()),
      events.concat(Ext_grid_AdvancedGroupStore.EVENTS())
    )
  }
