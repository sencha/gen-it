...
export default class Ext_grid_plugin_grouping_DropZone extends Ext_dd_DropZone {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_grid_plugin_grouping_DropZone.PROPERTIES()),
      events.concat(Ext_grid_plugin_grouping_DropZone.EVENTS())
    )
  }
