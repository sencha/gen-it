...
export default class Ext_grid_plugin_filterbar_filters_Date extends Ext_grid_plugin_filterbar_filters_SingleFilter {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_grid_plugin_filterbar_filters_Date.PROPERTIES()),
      events.concat(Ext_grid_plugin_filterbar_filters_Date.EVENTS())
    )
  }
