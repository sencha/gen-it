...
export default class Ext_grid_plugin_BaseGroupingPanel extends Ext_plugin_Abstract {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_grid_plugin_BaseGroupingPanel.PROPERTIES()),
      events.concat(Ext_grid_plugin_BaseGroupingPanel.EVENTS())
    )
  }
