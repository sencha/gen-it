...
var Ext_grid_plugin_filterbar_filters_List = /*#__PURE__*/function (_Ext_grid_plugin_filt) {
  _inheritsLoose(Ext_grid_plugin_filterbar_filters_List, _Ext_grid_plugin_filt);

  Ext_grid_plugin_filterbar_filters_List.PROPERTIES = function PROPERTIES() {
    return ['active', 'column', 'dataIndex', 'fieldDefaults', 'grid', 'operator', 'operators', 'options', 'serializer', 'updateBuffer'];
  };

  Ext_grid_plugin_filterbar_filters_List.EVENTS = function EVENTS() {
    return [{
      name: 'ready',
  ...
  Ext_grid_plugin_filterbar_filters_List.getProperties = function getProperties(properties) {
  ...
  Ext_grid_plugin_filterbar_filters_List.getEvents = function getEvents(events) {
  ...
  function Ext_grid_plugin_filterbar_filters_List(properties, events) {
    return _Ext_grid_plugin_filt.call(this, properties.concat(Ext_grid_plugin_filterbar_filters_List.PROPERTIES()), events.concat(Ext_grid_plugin_filterbar_filters_List.EVENTS())) || this;
  }

  var _proto = Ext_grid_plugin_filterbar_filters_List.prototype;
  ...
  _createClass(Ext_grid_plugin_filterbar_filters_List, null, [{
  ...
  return Ext_grid_plugin_filterbar_filters_List;
}(Ext_grid_plugin_filterbar_filters_SingleFilter);

export { Ext_grid_plugin_filterbar_filters_List as default };