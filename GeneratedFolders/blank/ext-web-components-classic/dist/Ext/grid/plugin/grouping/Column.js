...
var Ext_grid_plugin_grouping_Column = /*#__PURE__*/function (_Ext_Component) {
  _inheritsLoose(Ext_grid_plugin_grouping_Column, _Ext_Component);

  Ext_grid_plugin_grouping_Column.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_plugin_grouping_Column.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_plugin_grouping_Column.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_plugin_grouping_Column.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_grid_plugin_grouping_Column.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_plugin_grouping_Column.EVENTS());
    return Ext_Component.getEvents(events);
  };

  function Ext_grid_plugin_grouping_Column(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_grid_plugin_grouping_Column.PROPERTIES()), events.concat(Ext_grid_plugin_grouping_Column.EVENTS())) || this;
  }

  var _proto = Ext_grid_plugin_grouping_Column.prototype;
  ...
  _createClass(Ext_grid_plugin_grouping_Column, null, [{
  ...
  return Ext_grid_plugin_grouping_Column;
}(Ext_Component);

export { Ext_grid_plugin_grouping_Column as default };