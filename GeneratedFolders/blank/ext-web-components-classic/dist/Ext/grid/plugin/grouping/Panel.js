...
var Ext_grid_plugin_grouping_Panel = /*#__PURE__*/function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_grid_plugin_grouping_Panel, _Ext_panel_Panel);

  Ext_grid_plugin_grouping_Panel.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_plugin_grouping_Panel.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_plugin_grouping_Panel.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_plugin_grouping_Panel.PROPERTIES());
    return Ext_panel_Panel.getProperties(properties);
  };

  Ext_grid_plugin_grouping_Panel.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_plugin_grouping_Panel.EVENTS());
    return Ext_panel_Panel.getEvents(events);
  };

  function Ext_grid_plugin_grouping_Panel(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_grid_plugin_grouping_Panel.PROPERTIES()), events.concat(Ext_grid_plugin_grouping_Panel.EVENTS())) || this;
  }

  var _proto = Ext_grid_plugin_grouping_Panel.prototype;
  ...
  _createClass(Ext_grid_plugin_grouping_Panel, null, [{
  ...
  return Ext_grid_plugin_grouping_Panel;
}(Ext_panel_Panel);

export { Ext_grid_plugin_grouping_Panel as default };