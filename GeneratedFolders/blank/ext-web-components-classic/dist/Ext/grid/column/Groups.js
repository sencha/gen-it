...
var Ext_grid_column_Groups = /*#__PURE__*/function (_Ext_grid_column_Colu) {
  ...
  Ext_grid_column_Groups.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_column_Groups.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_column_Groups.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_column_Groups.EVENTS());
    return Ext_grid_column_Column.getEvents(events);
  };

  function Ext_grid_column_Groups(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_column_Groups.PROPERTIES()), events.concat(Ext_grid_column_Groups.EVENTS())) || this;
  }

  var _proto = Ext_grid_column_Groups.prototype;
  ...
  _createClass(Ext_grid_column_Groups, null, [{
  ...
  return Ext_grid_column_Groups;
}(Ext_grid_column_Column);

export { Ext_grid_column_Groups as default };