...
var Ext_data_TreeStore = /*#__PURE__*/function (_Ext_data_Store) {
  ...
  Ext_data_TreeStore.PROPERTIES = function PROPERTIES() {
    return ['associatedEntity', 'asynchronousLoad', 'autoDestroy', 'autoLoad', 'autoSort', 'autoSync', 'batchUpdateMode', 'clearOnLoad', 'clearOnPageLoad', 'clearRemovedOnLoad', 'data', 'defaultRootId', 'defaultRootProperty', 'defaultRootText', 'fields', 'filterer', 'filters', 'folderSort', 'groupDir', 'grouper', 'groupers', 'groupField', 'lazyFill', 'listeners', 'model', 'nodeParam', 'pageSize', 'parentIdProperty', 'proxy', 'reloadOnClearSorters', 'remoteFilter', 'remoteSort', 'remoteSummary', 'role', 'root', 'rootVisible', 'session', 'sorters', 'sortOnLoad', 'statefulFilters', 'storeId', 'trackRemoved'];
  };
