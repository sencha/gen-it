...
var Ext_data_BufferedStore = /*#__PURE__*/function (_Ext_data_ProxyStore) {
  ...
  Ext_data_BufferedStore.PROPERTIES = function PROPERTIES() {
    return ['asynchronousLoad', 'autoDestroy', 'autoLoad', 'autoSort', 'autoSync', 'batchUpdateMode', 'defaultViewSize', 'fields', 'filters', 'groupDir', 'grouper', 'groupers', 'groupField', 'leadingBufferZone', 'listeners', 'model', 'pageSize', 'proxy', 'purgePageCount', 'reloadOnClearSorters', 'remoteFilter', 'remoteSort', 'remoteSummary', 'sorters', 'sortOnLoad', 'statefulFilters', 'storeId', 'trackRemoved', 'trailingBufferZone', 'viewSize'];
  };
