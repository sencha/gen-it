...
var Ext_data_NodeStore = /*#__PURE__*/function (_Ext_data_Store) {
  ...
  Ext_data_NodeStore.PROPERTIES = function PROPERTIES() {
    return ['associatedEntity', 'asynchronousLoad', 'autoDestroy', 'autoLoad', 'autoSort', 'autoSync', 'batchUpdateMode', 'clearOnPageLoad', 'clearRemovedOnLoad', 'data', 'fields', 'filters', 'folderSort', 'groupDir', 'grouper', 'groupers', 'groupField', 'listeners', 'model', 'node', 'pageSize', 'proxy', 'recursive', 'reloadOnClearSorters', 'remoteFilter', 'remoteSort', 'remoteSummary', 'role', 'rootVisible', 'session', 'sorters', 'sortOnLoad', 'statefulFilters', 'storeId', 'trackRemoved'];
  };
