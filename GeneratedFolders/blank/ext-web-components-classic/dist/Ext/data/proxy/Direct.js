...
var Ext_data_proxy_Direct = /*#__PURE__*/function (_Ext_data_proxy_Serve) {
  ...
  Ext_data_proxy_Direct.PROPERTIES = function PROPERTIES() {
    return ['api', 'batchActions', 'batchOrder', 'cacheString', 'directFn', 'directionParam', 'extraParams', 'filterParam', 'groupDirectionParam', 'groupParam', 'idParam', 'limitParam', 'listeners', 'metadata', 'model', 'noCache', 'pageParam', 'paramOrder', 'paramsAsHash', 'reader', 'simpleGroupMode', 'simpleSortMode', 'sortParam', 'startParam', 'summaryParam', 'timeout', 'url', 'writer'];
  };
