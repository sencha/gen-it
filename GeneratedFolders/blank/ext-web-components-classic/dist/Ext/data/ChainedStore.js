...
var Ext_data_ChainedStore = /*#__PURE__*/function (_Ext_data_AbstractSto) {
  ...
  Ext_data_ChainedStore.PROPERTIES = function PROPERTIES() {
    return ['autoDestroy', 'autoSort', 'filters', 'groupDir', 'grouper', 'groupers', 'groupField', 'listeners', 'pageSize', 'reloadOnClearSorters', 'remoteFilter', 'remoteSort', 'remoteSummary', 'sorters', 'source', 'statefulFilters', 'storeId'];
  };
