...
var Ext_data_ProxyStore = /*#__PURE__*/function (_Ext_data_AbstractSto) {
  ...
  Ext_data_ProxyStore.PROPERTIES = function PROPERTIES() {
    return ['asynchronousLoad', 'autoDestroy', 'autoLoad', 'autoSort', 'autoSync', 'batchUpdateMode', 'fields', 'filters', 'groupDir', 'grouper', 'groupers', 'groupField', 'listeners', 'model', 'pageSize', 'proxy', 'reloadOnClearSorters', 'remoteFilter', 'remoteSort', 'remoteSummary', 'sorters', 'sortOnLoad', 'statefulFilters', 'storeId', 'trackRemoved'];
  };
