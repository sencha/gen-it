...
var Ext_data_ScriptTagProxy = /*#__PURE__*/function (_Ext_data_proxy_Serve) {
  ...
  Ext_data_ScriptTagProxy.PROPERTIES = function PROPERTIES() {
    return ['api', 'autoAppendParams', 'batchActions', 'batchOrder', 'cacheString', 'callbackKey', 'directionParam', 'extraParams', 'filterParam', 'groupDirectionParam', 'groupParam', 'idParam', 'limitParam', 'listeners', 'model', 'noCache', 'pageParam', 'reader', 'recordParam', 'simpleGroupMode', 'simpleSortMode', 'sortParam', 'startParam', 'summaryParam', 'timeout', 'url', 'writer'];
  };
