...
var Ext_data_AbstractStore = /*#__PURE__*/function (_Ext_Base) {
  ...
  Ext_data_AbstractStore.PROPERTIES = function PROPERTIES() {
    return ['autoDestroy', 'autoSort', 'filters', 'groupDir', 'grouper', 'groupers', 'groupField', 'listeners', 'pageSize', 'reloadOnClearSorters', 'remoteFilter', 'remoteSort', 'remoteSummary', 'sorters', 'statefulFilters', 'storeId'];
  };
