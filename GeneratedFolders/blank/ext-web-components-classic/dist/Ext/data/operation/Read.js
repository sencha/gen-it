...
var Ext_data_operation_Read = /*#__PURE__*/function (_Ext_data_operation_O) {
  ...
  Ext_data_operation_Read.PROPERTIES = function PROPERTIES() {
    return ['addRecords', 'batch', 'callback', 'filters', 'grouper', 'groupers', 'id', 'internalCallback', 'internalScope', 'limit', 'page', 'params', 'proxy', 'recordCreator', 'records', 'request', 'response', 'resultSet', 'scope', 'sorters', 'start', 'summaries', 'synchronous', 'url'];
  };
