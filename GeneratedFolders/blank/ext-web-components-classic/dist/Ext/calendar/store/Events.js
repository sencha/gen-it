...
var Ext_calendar_store_Events = /*#__PURE__*/function (_Ext_data_Store) {
  ...
  Ext_calendar_store_Events.PROPERTIES = function PROPERTIES() {
    return ['associatedEntity', 'asynchronousLoad', 'autoDestroy', 'autoLoad', 'autoSort', 'autoSync', 'batchUpdateMode', 'calendar', 'calendarParam', 'clearOnPageLoad', 'clearRemovedOnLoad', 'data', 'dateFormat', 'endParam', 'fields', 'filters', 'groupDir', 'grouper', 'groupers', 'groupField', 'listeners', 'model', 'pageSize', 'prefetchMode', 'proxy', 'reloadOnClearSorters', 'remoteFilter', 'remoteSort', 'remoteSummary', 'role', 'session', 'sorters', 'sortOnLoad', 'startParam', 'statefulFilters', 'storeId', 'trackRemoved'];
  };
