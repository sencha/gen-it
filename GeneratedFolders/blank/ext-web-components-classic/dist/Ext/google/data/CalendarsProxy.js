...
var Ext_google_data_CalendarsProxy = /*#__PURE__*/function (_Ext_google_data_Abst) {
  ...
  Ext_google_data_CalendarsProxy.PROPERTIES = function PROPERTIES() {
    return ['api', 'batchActions', 'batchOrder', 'cacheString', 'directionParam', 'extraParams', 'filterParam', 'groupDirectionParam', 'groupParam', 'idParam', 'limitParam', 'listeners', 'model', 'noCache', 'pageParam', 'reader', 'requiredScripts', 'simpleGroupMode', 'simpleSortMode', 'sortParam', 'startParam', 'summaryParam', 'timeout', 'url', 'writer'];
  };
