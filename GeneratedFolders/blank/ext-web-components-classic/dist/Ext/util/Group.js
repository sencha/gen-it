...
var Ext_util_Group = /*#__PURE__*/function (_Ext_util_Collection) {
  ...
  Ext_util_Group.PROPERTIES = function PROPERTIES() {
    return ['autoGroup', 'autoSort', 'data', 'decoder', 'defaultSortDirection', 'extraKeys', 'filters', 'groupConfig', 'grouper', 'groupers', 'groupKey', 'groups', 'keyFn', 'label', 'level', 'listeners', 'multiSortLimit', 'parent', 'path', 'rootProperty', 'sorters', 'source', 'trackGroups'];
  };
