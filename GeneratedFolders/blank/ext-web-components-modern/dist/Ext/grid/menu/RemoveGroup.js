...
var Ext_grid_menu_RemoveGroup = /*#__PURE__*/function (_Ext_menu_Item) {
  _inheritsLoose(Ext_grid_menu_RemoveGroup, _Ext_menu_Item);

  Ext_grid_menu_RemoveGroup.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_menu_RemoveGroup.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_menu_RemoveGroup.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_menu_RemoveGroup.PROPERTIES());
    return Ext_menu_Item.getProperties(properties);
  };

  Ext_grid_menu_RemoveGroup.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_menu_RemoveGroup.EVENTS());
    return Ext_menu_Item.getEvents(events);
  };

  function Ext_grid_menu_RemoveGroup(properties, events) {
    return _Ext_menu_Item.call(this, properties.concat(Ext_grid_menu_RemoveGroup.PROPERTIES()), events.concat(Ext_grid_menu_RemoveGroup.EVENTS())) || this;
  }

  var _proto = Ext_grid_menu_RemoveGroup.prototype;
  ...
  _createClass(Ext_grid_menu_RemoveGroup, null, [{
  ...
  return Ext_grid_menu_RemoveGroup;
}(Ext_menu_Item);

export { Ext_grid_menu_RemoveGroup as default };