...
var Ext_grid_menu_AddGroup = /*#__PURE__*/function (_Ext_menu_Item) {
  _inheritsLoose(Ext_grid_menu_AddGroup, _Ext_menu_Item);

  Ext_grid_menu_AddGroup.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_menu_AddGroup.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_menu_AddGroup.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_menu_AddGroup.PROPERTIES());
    return Ext_menu_Item.getProperties(properties);
  };

  Ext_grid_menu_AddGroup.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_menu_AddGroup.EVENTS());
    return Ext_menu_Item.getEvents(events);
  };

  function Ext_grid_menu_AddGroup(properties, events) {
    return _Ext_menu_Item.call(this, properties.concat(Ext_grid_menu_AddGroup.PROPERTIES()), events.concat(Ext_grid_menu_AddGroup.EVENTS())) || this;
  }

  var _proto = Ext_grid_menu_AddGroup.prototype;
  ...
  _createClass(Ext_grid_menu_AddGroup, null, [{
  ...
  return Ext_grid_menu_AddGroup;
}(Ext_menu_Item);

export { Ext_grid_menu_AddGroup as default };