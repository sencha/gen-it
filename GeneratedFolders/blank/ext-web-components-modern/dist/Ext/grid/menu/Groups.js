...
var Ext_grid_menu_Groups = /*#__PURE__*/function (_Ext_menu_Item) {
  _inheritsLoose(Ext_grid_menu_Groups, _Ext_menu_Item);

  Ext_grid_menu_Groups.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_menu_Groups.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_menu_Groups.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_menu_Groups.PROPERTIES());
    return Ext_menu_Item.getProperties(properties);
  };

  Ext_grid_menu_Groups.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_menu_Groups.EVENTS());
    return Ext_menu_Item.getEvents(events);
  };

  function Ext_grid_menu_Groups(properties, events) {
    return _Ext_menu_Item.call(this, properties.concat(Ext_grid_menu_Groups.PROPERTIES()), events.concat(Ext_grid_menu_Groups.EVENTS())) || this;
  }

  var _proto = Ext_grid_menu_Groups.prototype;
  ...
  _createClass(Ext_grid_menu_Groups, null, [{
  ...
  return Ext_grid_menu_Groups;
}(Ext_menu_Item);

export { Ext_grid_menu_Groups as default };