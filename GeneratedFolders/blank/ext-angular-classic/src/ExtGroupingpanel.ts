//import EWCGroupingpanel from '../dist/ext-groupingpanel.component.js';
//inputs: (new EWCGroupingpanel()).properties,
//import EWCGroupingpanel from '@sencha/ext-web-components-classic/dist/ext-groupingpanel.component.js';
import { EWCGroupingpanel } from '@sencha/ext-web-components-classic';
import {
    Host,
    Optional,
    SkipSelf,
...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtGroupingpanelComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtGroupingpanelComponent extends EngBase {
    constructor(
        eRef: ElementRef,
...
//var events = (new EWCGroupingpanel()).eventnames;
//var eventnamesall = [];
