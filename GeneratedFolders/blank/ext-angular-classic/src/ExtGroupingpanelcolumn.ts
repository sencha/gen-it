//import EWCGroupingpanelcolumn from '../dist/ext-groupingpanelcolumn.component.js';
//inputs: (new EWCGroupingpanelcolumn()).properties,
//import EWCGroupingpanelcolumn from '@sencha/ext-web-components-classic/dist/ext-groupingpanelcolumn.component.js';
import { EWCGroupingpanelcolumn } from '@sencha/ext-web-components-classic';
import {
    Host,
    Optional,
    SkipSelf,
...
@Component({
    selector: 'ExtGroupingpanelcolumn',
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtGroupingpanelcolumnComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtGroupingpanelcolumnComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCGroupingpanelcolumn()).events,
...
//var events = (new EWCGroupingpanelcolumn()).eventnames;
//var eventnamesall = [];
