...
//import EWCGroupscolumn from '@sencha/ext-web-components-classic/dist/ext-groupscolumn.component.js';
import { EWCGroupscolumn } from '@sencha/ext-web-components-classic';
import {
    Host,
    Optional,
    SkipSelf,
