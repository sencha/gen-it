...
//import EWCGroupingpanel from '@sencha/ext-web-components-modern/dist/ext-groupingpanel.component.js';
import { EWCGroupingpanel } from '@sencha/ext-web-components-modern';
import {
    Host,
    Optional,
    SkipSelf,
