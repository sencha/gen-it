//import EWCGroupcell from '../dist/ext-groupcell.component.js';
//inputs: (new EWCGroupcell()).properties,
//import EWCGroupcell from '@sencha/ext-web-components-modern/dist/ext-groupcell.component.js';
import { EWCGroupcell } from '@sencha/ext-web-components-modern';
import {
    Host,
    Optional,
    SkipSelf,
...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtGroupcellComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtGroupcellComponent extends EngBase {
    constructor(
        eRef: ElementRef,
...
//var events = (new EWCGroupcell()).eventnames;
//var eventnamesall = [];
