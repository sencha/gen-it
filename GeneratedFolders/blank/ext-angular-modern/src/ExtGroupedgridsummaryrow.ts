//import EWCGroupedgridsummaryrow from '../dist/ext-groupedgridsummaryrow.component.js';
//inputs: (new EWCGroupedgridsummaryrow()).properties,
//import EWCGroupedgridsummaryrow from '@sencha/ext-web-components-modern/dist/ext-groupedgridsummaryrow.component.js';
import { EWCGroupedgridsummaryrow } from '@sencha/ext-web-components-modern';
import {
    Host,
    Optional,
    SkipSelf,
...
@Component({
    selector: 'ExtGroupedgridsummaryrow',
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtGroupedgridsummaryrowComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtGroupedgridsummaryrowComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCGroupedgridsummaryrow()).events,
...
//var events = (new EWCGroupedgridsummaryrow()).eventnames;
//var eventnamesall = [];
