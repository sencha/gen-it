//import EWCGridgroupsmenuitem from '../dist/ext-gridgroupsmenuitem.component.js';
//inputs: (new EWCGridgroupsmenuitem()).properties,
//import EWCGridgroupsmenuitem from '@sencha/ext-web-components-modern/dist/ext-gridgroupsmenuitem.component.js';
import { EWCGridgroupsmenuitem } from '@sencha/ext-web-components-modern';
import {
    Host,
    Optional,
    SkipSelf,
...
@Component({
    selector: 'ExtGridgroupsmenuitem',
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtGridgroupsmenuitemComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtGridgroupsmenuitemComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCGridgroupsmenuitem()).events,
...
//var events = (new EWCGridgroupsmenuitem()).eventnames;
//var eventnamesall = [];
