...
import TreeGroupedGridComponent from './view/grids/add-ons/treegroupedgrid/TreeGroupedGridComponent.js';
...
import GridFilterBarComponent from './view/grids/add-ons/gridfilterbar/GridFilterbarComponent.js';
    ...
    return [
        ...
        { text: 'Grids', iconCls: 'icon-grids', children: [
            ...
            { text: 'Add-ons', iconCls: 'icon-framing-buttons', children: [
                { text: 'Tree Grouped Grid', component: TreeGroupedGridComponent, iconCls: 'icon-tree-grouped-grid'},
